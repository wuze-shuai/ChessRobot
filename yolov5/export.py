...
def parse_opt(known=False):
    ...
    parser.add_argument("--int8", action="store_false", help="CoreML/TF/OpenVINO INT8 quantization")
    ...
    parser.add_argument("--iou-thres", type=float, default=0.55, help="TF.js NMS: IoU threshold")
    parser.add_argument("--conf-thres", type=float, default=0.8, help="TF.js NMS: confidence threshold")
    parser.add_argument(
        "--include",
        nargs="+",
        default=["onnx"],
